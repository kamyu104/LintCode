...
|364|[Trapping Rain Water II](http://lintcode.com/en/problem/trapping-rain-water-ii/)| [C++](./C++/trapping-rain-water-ii.cpp)| _O(m * n * max(logm, logn))_ | _O(m * n)_ | Hard | | BFS, Heap, Tricky |
